package com.example.sehirlerinplakasi

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.view.KeyCharacterMap.load
import com.example.sehirlerinplakasi.databinding.ActivityMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.button.setOnClickListener{
            if (binding.editTextNumber.text.isNotEmpty()){
                ...
                when(plakaKodu){
                    1 -> {
                        binding.textView.text = "Adana"
                        Picasso.get().load(R.drawable.adanaresim).into(binding.imageView);
                    }
                    ...
                    81 -> binding.textView.text = "Düzce"
                        ...
                        Picasso.get().load(R.drawable.turkbayragi).into(binding.imageView);
                ...
                binding.textView.text = "1-81 arası plaka giriniz."
            }
